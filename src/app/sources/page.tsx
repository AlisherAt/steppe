    ...
    <main id="main-content" className="page-content">
      ...
      <div className="info-panel">
        ...
        <p>
          ...
          размера. Для Puma проверяется американский магазин; местонахождение склада не заявляется.
          Импорт StockX отключён: рыночная котировка не подтверждает стоимость выкупа.
        </p>
        <p>
